...
(function (_) {
          ...
          if (n && na(h.h, m))
            for (h = 0; h < n.length; h++) {
              ...
              if ((k !== k && p.key !== p.key) || k === p.key)
                return { id: m, list: n, index: h, M: p };
            }
  ...
  try {
    ...
    _.sa = function () {
      return ((_.v('Chrome') || _.v('CriOS')) && !_.v('Edge')) || _.v('Silk');
    };
    ua = function () {
    ...
    _.Ba = function (a) {
      return _.Aa && null != a && a instanceof Uint8Array;
    };
    _.Da = function (a) {
      Object.isFrozen(a) ||
        (Ca
          ...
          : Object.defineProperties(a, {
              Xa: { value: 1, configurable: !0, writable: !0, enumerable: !1 },
            }));
      return a;
    };
    Ea = function (a) {
    ...
    _.Ga = function (a) {
      switch (typeof a) {
        ...
        case 'object':
          if (_.Ba(a)) return _.Fa(a);
      }
      return a;
    };
    Ia = function (a, b) {
      if (null != a) return Array.isArray(a) || Ea(a) ? _.Ha(a, b) : b(a);
    };
    _.Ha = function (a, b) {
      if (Array.isArray(a)) {
    ...
    */
    ...
    _.Ta = 'undefined' !== typeof TextDecoder;
    var Va;
    _.Ua = String.prototype.trim
      ? function (a) {
          return a.trim();
        }
      : function (a) {
    ...
    var ib;
    _.cb = _.v('Opera');
    _.db = _.v('Trident') || _.v('MSIE');
    _.eb = _.v('Edge');
    _.fb =
      _.v('Gecko') &&
      !(-1 != _.qa.toLowerCase().indexOf('webkit') && !_.v('Edge')) &&
      !(_.v('Trident') || _.v('MSIE')) &&
      !_.v('Edge');
    _.gb = -1 != _.qa.toLowerCase().indexOf('webkit') && !_.v('Edge');
    _.hb = _.va();
    a: {
      var jb = '',
        kb = (function () {
          ...
          if (_.db) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
          if (_.gb) return /WebKit\/(\S+)/.exec(a);
    ...
    _.pb = ua() || _.v('iPod');
    _.qb = _.v('iPad');
    _.rb = _.v('Android') && !(_.sa() || _.ra() || _.v('Opera') || _.v('Silk'));
    _.sb = _.sa();
    _.tb = _.ta() && !_.va();
    var ub;
    ub = {};
    ...
    _.Aa = 'function' === typeof Uint8Array;
    ...
    _.E = function (a, b, c) {
      ...
      _.Ab = null;
      a || (a = d);
      d = this.constructor.fd;
      a || (a = d ? [d] : []);
      this.i = (d ? 0 : -1) - (this.constructor.cd || 0);
      this.g = null;
      this.N = a;
      a: {
        d = this.N.length;
        a = d - 1;
        if (d && ((d = this.N[a]), Ea(d))) {
          this.j = a - this.i;
          this.h = d;
          break a;
        }
    ...
    _.Db = Symbol();
    _.Eb = Symbol();
    _.La = { debug: 0, info: 1, warn: 2, error: 3 };
    _.Ma = 'warn';
    ...
    Rb = new _.Pb(
      (_.B.trustedTypes && _.B.trustedTypes.emptyHTML) || '',
      0,
      _.Ob
    );
    _.Sb = (function (a) {
    ...
    _.Wb.prototype.stopPropagation = function () {
      this.h = !0;
    };
    _.Wb.prototype.preventDefault = function () {
    ...
    var Xb = (function () {
      ...
      try {
        _.B.addEventListener('test', _.Qa, b),
          _.B.removeEventListener('test', _.Qa, b);
      } catch (c) {}
      return a;
    })();
    var Zb = function (a, b) {
      _.Wb.call(this, a ? a.type : '');
      ...
      if (a) {
        ...
        d
          ...
          : ((this.i = _.gb || void 0 !== a.offsetX ? a.offsetX : a.layerX),
            (this.j = _.gb || void 0 !== a.offsetY ? a.offsetY : a.layerY),
        ...
        this.state = a.state;
        this.R = a;
        a.defaultPrevented && Zb.ma.preventDefault.call(this);
      }
    };
    _.Sa(Zb, _.Wb);
    var Yb = { 2: 'touch', 3: 'pen', 4: 'mouse' };
    Zb.prototype.stopPropagation = function () {
      Zb.ma.stopPropagation.call(this);
      this.R.stopPropagation
        ? this.R.stopPropagation()
        : (this.R.cancelBubble = !0);
    };
    Zb.prototype.preventDefault = function () {
      Zb.ma.preventDefault.call(this);
      var a = this.R;
      a.preventDefault ? a.preventDefault() : (a.returnValue = !1);
    };
    Zb.prototype.Gc = function () {
      return this.R;
    };
    var $b;
    ...
    ec.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.Qa = !1))
        : ((b = new cc(b, this.src, f, !!d, e)), (b.Qa = c), a.push(b));
      return b;
    };
    gc = function (a, b) {
      var c = b.type;
    ...
    ec.prototype.Ea = function (a, b, c, d) {
      a = this.g[a.toString()];
      var e = -1;
      a && (e = fc(a, b, c, d));
      return -1 < e ? a[e] : null;
    ...
    var fc = function (a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.Ga && f.listener == b && f.capture == !!c && f.handler == d)
          return e;
      }
      return -1;
    };
    ...
    sc = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.Ra(d) ? !!d.capture : !!d),
          ...
          _.ac(a)
            ? a.na(b, c, d, e)
            : a && (a = _.oc(a)) && (b = a.Ea(b, c, d, e)) && _.tc(b);
    };
    _.tc = function (a) {
      ...
      b.removeEventListener
        ...
        : b.detachEvent
        ? b.detachEvent(qc(c), d)
        : b.addListener && b.removeListener && b.removeListener(d);
      kc--;
      (c = _.oc(b))
        ? (gc(c, a), 0 == c.h && ((c.src = null), (b[ic] = null)))
        : dc(a);
      return !0;
    };
    qc = function (a) {
    ...
    _.l.dispatchEvent = function (a) {
      ...
      c = this.va;
      var d = a.type || a;
      if ('string' === typeof a) a = new _.Wb(a, c);
      else if (a instanceof _.Wb) a.target = a.target || c;
      else {
        var e = a;
        a = new _.Wb(d, c);
        Oa(a, e);
    ...
    _.vc.prototype.Ea = function (a, b, c, d) {
      return this.V.Ea(String(a), b, c, d);
    };
    var xc = function () {};
    xc.prototype.g = null;
    var zc;
    ...
    var Hc, Jc, Rc, Kc, Mc, Lc, Pc, Nc, Sc;
    _.Cc = function (a, b) {
      ...
      a instanceof _.Cc
        ...
        ? ((this.l = !!b),
          ...
          _.Fc(this, c[6] || '', !0),
          (this.m = Hc(c[7] || '')))
        : ((this.l = !!b), (this.j = new _.Ic(null, this.l)));
    };
    ...
    _.Fc = function (a, b, c) {
      b instanceof _.Ic
        ? ((a.j = b), Oc(a.j, a.l))
        : (c || (b = Jc(b, Pc)), (a.j = new _.Ic(b, a.l)));
    };
    _.Qc = function (a) {
    ...
    _.l.aa = function (a) {
      ...
      var b = [];
      if ('string' === typeof a)
        Vc(this, a) && (b = b.concat(this.g.get(Tc(this, a))));
      else {
    ...
    _.Wc = function (a, b, c) {
      _.Uc(a, b);
      0 < c.length &&
        ((a.i = null), a.g.set(Tc(a, b), _.ya(c)), (a.h += c.length));
    };
  ...
  try {
    ...
    _.Zc = function (a) {
      if (!a.startsWith(")]}'\n"))
        throw (console.error('malformed JSON response:', a), Error('N'));
      a = a.substr(5);
    ...
    _.id = function (a, b, c, d) {
      ...
      if (_.Ra(b))
        if (b instanceof _.ed) {
          if (b.za !== fd) throw Error('Q');
          b = gd(b.toString(), b.Ta || null);
        } else b = hd('zSoyz');
      else b = hd(String(b));
      if ((0, _.Sb)()) for (; a.lastChild; ) a.removeChild(a.lastChild);
      a.innerHTML = _.Qb(b);
    };
    ...
    _.ud = function (a) {
      return a instanceof _.td && a.constructor === _.td
        ? a.g
      ...
      if (void 0 === rd) {
        ...
        if (d && d.createPolicy) {
          try {
            ...
            _.B.console && _.B.console.error(e.message);
          }
          rd = c;
        } else rd = c;
      }
    ...
    hd = function (a) {
      ...
      qd.test(a) &&
        ...
        -1 != a.indexOf('\x00') && (a = a.replace(pd, '&#0;')));
      return gd(a, c);
    };
    _.vd = function (a) {
      _.E.call(this, a);
    ...
    _.Ad.prototype.resolve = function (a) {
      if (!this.i) throw Error('M');
      this.i(a);
      this.P();
    };
    _.Ad.prototype.reject = function (a) {
      if (!this.h) throw Error('M');
      this.h(a);
      this.P();
    };
    ...
    */
    ...
    _.L = function (a) {
      return _.Id(a, fd)
        ? a
        : a instanceof _.Pb
        ? (0, _.K)(_.Qb(a).toString(), a.Ua())
        : (0, _.K)(String(String(a)).replace(Kd, Ld), Jd(a));
    };
    _.K = (function (a) {
      function b(c) {
        this.content = c;
    ...
    _.N = function (a) {
      _.Id(a, fd)
        ? ((a = String(a.content).replace(Od, '').replace(Pd, '&lt;')),
          (a = _.Qd(a)))
        : (a = String(a).replace(Kd, Ld));
      return a;
    };
    _.Wd = function (a) {
      _.Id(a, _.Fd) || _.Id(a, _.Gd)
        ? (a = _.Sd(a))
        : a instanceof _.Jb
        ? (a = _.Sd(_.Kb(a)))
        : a instanceof _.Cd
        ? (a = _.Sd(_.ad(a)))
        : a instanceof _.td
        ? (a = _.Sd(_.ud(a).toString()))
        : ((a = String(a)),
          (a = Td.test(a) ? a.replace(_.Ud, _.Vd) : 'about:invalid#zSoyz'));
      return a;
    };
    Xd = {
      '\x00': '&#0;',
    ...
    _.$d = function (a) {
      return (0, _.K)(
        (a
          ...
          : '<svg class="' +
            _.N('fFW7wc-ibnC6b-HiaYvf') +
            ' ' +
            _.N('zTETae-mzNpsf-Bz112c') +
            ' ' +
            _.N('n1UuX-DkfjY') +
            '" aria-hidden=true viewBox="0 0 192 192">') +
  ...
  try {
    ...
    _.oh = function (a, b, c) {
      ...
      if (b && 2 === b.Mb()) {
        ...
        b && 2 === _.F(b, 10) && !_.J('disable_personalized_button')
          ? ((c = void 0 === c ? !0 : c),
            b && null != _.F(b, 8)
              ? ((d = {}),
                b &&
    ...
    var vh = {},
      wh = function (a, b) {
        return a && b && a.Ic && b.Ic
          ? a.za !== b.za
            ? !1
            : a.toString() === b.toString()
          : a instanceof _.ed && b instanceof _.ed
          ? a.za != b.za
            ? !1
            : a.toString() == b.toString()
          : a == b;
      ...
      zh = function (a) {
        _.Id(a, vh)
          ...
          : a instanceof rh
          ? (a = xh(
              a instanceof rh && a.constructor === rh
                ? a.g
                : 'type_error:SafeStyle'
            ))
          : a instanceof th
          ? (a = xh(
              a instanceof th && a.constructor === th
                ? a.g
                : 'type_error:SafeStyleSheet'
            ))
          : ((a = String(a)), (a = yh.test(a) ? a : 'zSoyz'));
        return a;
      },
      Ah = function () {
        return (0, _.K)(
    ...
    var Fh = function (a, b, c, d, e, f, g, h) {
        ...
        return m(
          g +
            ...
            (_.Md(f) && !h
              ...
              : '') +
            '><div class="' +
            _.N('nsm7Bb-HzV7m-LgbsSe-MJoBVe') +
            '"></div><div class="' +
            _.N('nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb') +
            ' ' +
            (wh(a, 2) ? _.N('oXtfBe-l4eHX') : '') +
            '">' +
            Eh(wh(c, 2) || wh(c, 3)) +
            (h
              ? ''
              : '<span class="' +
                _.N('nsm7Bb-HzV7m-LgbsSe-BPrWId') +
                '">' +
                _.L(Bh(e)) +
                '</span>') +
            '<span class="' +
      ...
      Eh = function (a) {
        return (0, _.K)(
          (void 0 === a ? 0 : a)
            ? '<div class="' +
                _.N('nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf') +
                '"><div class="' +
                _.N('nsm7Bb-HzV7m-LgbsSe-Bz112c') +
                '">' +
                Ah() +
                '</div></div>'
            : '<div class="' +
      ...
      mh = function (a) {
        ...
        d.la
          ? ((f +=
              ...
              _.N(_.Wd(d.la)) +
              '" alt="'),
            (a = _.N(b ? b : d.id) + "'s profile image"),
            (f += _.Qd(a)),
            (f += '">'))
          : (f += _.$d());
        a =
  ...
  try {
    ...
    */
    ...
    we = function (a) {
      ...
      a.Za && (_.B.clearTimeout(a.Za), (a.Za = null));
    };
    xe = function (a) {
      return (
        _.db &&
    ...
    ye = function (a) {
      a.sb ||
        ((a.sb = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'));
    };
    ze = function (a, b) {
      if (a.u) {
        we(a);
    ...
    _.Be = function (a) {
      ...
      if (!c) {
        if ((b = 0 === b))
          (a = String(a.wb).match(_.Ac)[1] || null),
            !a &&
              _.B.self &&
              _.B.self.location &&
              ((a = _.B.self.location.protocol),
              (a = a.substr(0, a.length - 1))),
            (b = !te.test(a ? a.toLowerCase() : ''));
        c = b;
      }
      return c;
    };
    Ce = function (a) {
      if (
        a.ja &&
        'undefined' != typeof _.Pa &&
        (!a.cb[1] || 4 != Ae(a) || 2 != a.Va())
      )
    ...
    _.l.send = function (a, b, c, d) {
      if (this.u) throw Error('H`' + this.wb + '`' + a);
      b = b ? b.toUpperCase() : 'GET';
      this.wb = a;
      this.sb = !1;
      this.ja = !0;
      this.u = this.eb ? re(this.eb) : re(_.yc);
      this.cb = this.eb ? qe(this.eb) : qe(_.yc);
      this.u.onreadystatechange = (0, _.ke)(this.bc, this);
      this.Nc &&
        'onprogress' in this.u &&
        ((this.u.onprogress = (0, _.ke)(function (g) {
          this.ac(g, !0);
        }, this)),
        this.u.upload && (this.u.upload.onprogress = (0, _.ke)(this.ac, this)));
      try {
      ...
      if (d)
        ...
        } else throw Error('I`' + String(d));
      d = Array.from(c.keys()).find(function (g) {
        return 'content-type' == g.toLowerCase();
      });
      e = _.B.FormData && a instanceof _.B.FormData;
      !(0 <= (0, _.wa)(ue, b)) ||
        d ||
        e ||
        c.set(
      ...
      'withCredentials' in this.u &&
        this.u.withCredentials !== this.Gb &&
        (this.u.withCredentials = this.Gb);
      if ('setTrustToken' in this.u && this.Db)
        try {
      ...
      try {
        we(this),
          0 < this.$a &&
            ((this.Fb = xe(this.u))
              ? ((this.u.timeout = this.$a),
                (this.u.ontimeout = (0, _.ke)(this.fc, this)))
              : (this.Za = se(this.fc, this.$a, this))),
          (this.Wa = !0),
          this.u.send(a),
          (this.Wa = !1);
      } catch (g) {
    ...
    _.l.U = function () {
      this.u &&
        (this.ja &&
          ((this.ja = !1), (this.qa = !0), this.u.abort(), (this.qa = !1)),
        ze(this, !0));
      Ee.ma.U.call(this);
    };
    _.l.bc = function () {
      this.sa || (this.ub || this.Wa || this.qa ? Ce(this) : this.Mc());
    };
    _.l.Mc = function () {
      Ce(this);
    };
    ...
    var Je = function () {
      ...
      Me = function (a, b) {
        ...
        this.m = a;
        this.l = b;
        this.o = _.B.Int32Array ? new Int32Array(64) : Array(64);
        void 0 === Ke &&
          (_.B.Int32Array ? (Ke = new Int32Array(Le)) : (Ke = Le));
        this.reset();
      };
    _.Sa(Me, Je);
    Me.prototype.reset = function () {
      this.j = this.h = 0;
      this.g = _.B.Int32Array ? new Int32Array(this.l) : _.ya(this.l);
    };
    var Ne = function (a) {
    ...
    Me.prototype.digest = function () {
      var a = [],
        b = 8 * this.j;
      56 > this.h
        ? this.update(_.Hb, 56 - this.h)
        : this.update(_.Hb, this.blockSize - (this.h - 56));
    ...
    _.l.set = function (a, b, c) {
      ...
      if (/[;=\s]/.test(a)) throw Error('R`' + a);
      if (/[;\r\n]/.test(b)) throw Error('S`' + b);
      void 0 === h && (h = -1);
      this.g.cookie =
        a +
        '=' +
  ...
  try {
    ...
    */
    ...
    Qh = (function () {
      if (_.ob) return Ph(/Firefox\/([0-9.]+)/);
      if (_.db || _.eb || _.cb) return _.nb;
      if (_.sb) {
      ...
      if (_.tb && !_.va()) return Ph(/Version\/([0-9.]+)/);
      if (_.pb || _.qb) {
  ...
  try {
    ...
    */
    ...
    _.bi =
      ...
      (ai.enable_web_id = [
        '28250620661-550h2e8djhee3ri2nma0u294i6ks921r.apps.googleusercontent.com',
        '28250620661-jplop9r4d3uj679blu2nechmlm3h89gk.apps.googleusercontent.com',
        '721418733929-55iv503445sqh9rospct8lthb3n46f3k.apps.googleusercontent.com',
      ]),
      ai);
  } catch (e) {
    _._DumpException(e);
  ...
  try {
    var Bk, Ck;
    Bk = /^data:(.*);base64,[a-z0-9+\/]+=*$/i;
    Ck = {};
    _.Dk = function (a) {
      this.g = (Ck === Ck && a) || '';
    };
    _.Dk.prototype.ba = !0;
    _.Dk.prototype.Y = function () {
      return this.g;
    };
    _.Ek = function (a, b, c) {
      _.xd(
    ...
    _.Fk = function (a, b) {
      ...
      if (!(d instanceof _.Jb))
        if (
          ((d = 'object' == typeof d && d.ba ? d.Y() : String(d)), _.Mb.test(d))
        )
          d = new _.Jb(d, _.Ib);
        else {
          d = String(d);
  ...
  try {
    ...
    */
    ...
    Kl = !_.db && !_.ta();
    _.Ll = function (a) {
      if (Kl && a.dataset) return a.dataset;
      var b = {};
      a = a.attributes;
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (0 == d.name.lastIndexOf('data-', 0)) {
          var e = _.Il(d.name.substr(5));
          b[e] = d.value;
        }
      }
      return b;
  ...
  try {
    ...
    Rl = function (a) {
      ...
      if ('string' === typeof a) return Xl(a);
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++)
          if ('string' !== typeof a[b] || !Xl(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    Xl = function (a) {
      try {
        ...
        a = c;
        b = 'vb';
        if (Yl.vb && Yl.hasOwnProperty(b)) var d = Yl.vb;
        else {
          var e = new Yl();
          d = Yl.vb = e;
        }
    ...
    Tl = function () {
      $l ||
        ($l = _.G(window, 'message', function (a) {
          a = a.R;
          if (a.data) {
            var b = a.data;
    ...
    _.dm = function (a) {
      _.Ol
        ? _.Pl({ command: 'intermediate_iframe_resize', height: a })
        : _.x(
    ...
    _.em = function () {
      _.Ol
        ? _.Pl({ command: 'intermediate_iframe_close' })
        : _.x(
    ...
    _.fm = function (a) {
      _.Ol
        ? _.Pl({ command: 'set_tap_outside_mode', cancel: a })
        : _.x(
    ...
    */
    ...
    var hm = function (a, b, c, d) {
      ...
      if (d && void 0 !== a.h) throw Error('pa`' + b);
      a.h = c;
    };
    ...
    var im = function (a, b) {
      ...
      for (var c in a.g) im(a.g[c], b);
    };
    gm.prototype.Da = function (a) {
      var b = [];
      if (a) {
    ...
    var jm = function (a, b, c) {
      void 0 !== a.h && c.push(b);
      for (var d in a.g) jm(a.g[d], b + d, c);
    };
    ...
    var Yl = function () {
      ...
      lm = function (a, b, c, d) {
        ...
        a++;
        if ('?' == e || ',' == e) return a;
        do (a = lm(a, b, c, d)), (e = c.charAt(a));
        while ('?' != e && ',' != e);
        return a + 1;
      };
    var Sl, $l, Ql, Ul, Vl;
    _.D('google.accounts.id.intermediate.verifyParentOrigin', _.Wl);
    _.D('google.accounts.id.intermediate.notifyParentResize', _.dm);
    _.D('google.accounts.id.intermediate.notifyParentClose', _.em);
    _.D('google.accounts.id.intermediate.notifyParentDone', function () {
      _.Ol
        ? _.Pl({ command: 'intermediate_iframe_done' })
        : _.x(
            'Done command was not sent due to missing verified parent origin.'
          );
    });
    _.D('google.accounts.id.intermediate.notifyParentTapOutsideMode', _.fm);
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var mm = function (a) {
      ...
      Jm = function (a, b) {
        Fm >= (void 0 === b ? 100 : b) ||
          ((b = new _.Cc(Gm)),
          _.Fc(b, _.Ye({ client_id: Hm, as: Im, event: a.toString() })),
          _.Xe(
            b.toString(),
            void 0,
            'POST',
            ...
            void 0,
            void 0,
            'https://accounts.google.com/gsi/log' !== Gm
          ));
      },
      Nm = function (a) {
        var b = new (Function.prototype.bind.apply(
          Km,
          [null, 'onetap', a, 'prompt'].concat(Lm(Mm.apply(1, arguments)))
        ))();
        Jm(b);
      },
      Om = function () {
        var a = new (Function.prototype.bind.apply(
          Km,
          [null, 'onetap', void 0, 'closed'].concat(Lm(Mm.apply(0, arguments)))
        ))();
        Jm(a);
      },
      Pm = function () {
        var a = new (Function.prototype.bind.apply(
          Km,
          [null, 'id', void 0, 'init'].concat(Lm(Mm.apply(0, arguments)))
        ))();
        Jm(a);
      },
      Vm = function () {
        ...
        if (a) {
          ...
          for (d in b)
            b.hasOwnProperty(d) &&
              0 > Rm.indexOf(d.toLowerCase()) &&
              (c[d] = b[d]);
          a.state && (c.state = a.state);
          if ((d = a.login_uri)) {
            b = _.Qc(d);
            b.g ||
              (_.Dc(b, location.protocol),
              (b.g = location.hostname),
              _.Ec(b, location.port),
              Pm('relativeLoginUri', d),
              _.x(
            ...
            if ('https' !== b.h && 'localhost' !== b.g)
              throw (
                (Pm('unsecuredLoginUri', d),
                new Sm('Unsecured login_uri provided.'))
              );
            d = b.toString();
            a.login_uri = d;
          }
          d && !a.callback && (a.callback = Tm(d, c));
          'redirect' !== a.ux_mode ||
            d ||
        ...
        return function (c) {
          c && c.credential
            ? ((b.credential = c.credential),
              (b.g_csrf_token = vm()),
              _.fk(a, b))
            : Y('No credential found in the response.');
        };
      },
      Um = function (a, b, c, d) {
        return function (e) {
          e && 'password' === e.type
            ? ((b[c] = e.id), (b[d] = e.password), _.fk(a, b))
            : Y('No password credential returned.');
        };
      },
      Xm = function (a) {
        a = _.Ll(a);
      ...
      an = function (a) {
        a = new Ym(a);
        Zm.__G_ID_CLIENT__ = a;
        ym(a.vc);
        $m(a);
        return a;
      },
      bn = function (a, b, c) {
        var d = Zm.__G_ID_CLIENT__;
        d || (an(), (d = Zm.__G_ID_CLIENT__));
        d.C(a, b, c);
      },
      dn = function (a, b, c) {
        if (a && b) {
      ...
      fn = function () {
        var a = Zm.__G_ID_CLIENT__;
        a || (an(), (a = Zm.__G_ID_CLIENT__));
        en(a.o);
      },
      gn = function () {
        var a = void 0 === a ? document.readyState : a;
        for (var b = _.Qe('g_id_signout'), c = 0; c < b.length; c++)
          _.G(b[c], 'click', fn);
        try {
          var d = Vm();
          if (d) {
      ...
      ln = function (a, b, c) {
        ...
        kn(c, 'access_type', g);
        kn(c, 'hd', n);
        kn(c, 'response_type', f);
        kn(c, 'include_granted_scopes', !1 === p ? 'false' : 'true');
        kn(c, 'enable_serial_consent', !1 === t ? 'false' : 'true');
        return b + '?' + c.join('&');
      },
      mn = function (a, b) {
        if (!b.client_id) throw Error('ta');
        if (!b.scope) throw Error('ua');
        var c = {
      ...
      on = function (a) {
        return (a = a && a.scope && a.scope.trim())
          ? nn.apply(null, Lm(a.split(' ')))
          : null;
      },
      pn = function (a) {
        _.Ek(a, 'prompt_closed', { bd: !1 });
      },
      qn = function (a, b, c) {
        b = { hd: b };
        void 0 != c && (b.oldHeight = c);
        _.Ek(a, 'prompt_resized', b);
      },
      Lm = function (a) {
    ...
    _.A(tn, _.E);
    var un = { left: 1, center: 2 },
      vn = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      wn = { large: 1, medium: 2, small: 3 },
      xn = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      yn = { outline: 1, filled_blue: 2, filled_black: 3 },
      zn = { standard: 1, icon: 2 },
      An = function (a, b, c) {
        this.container = a;
        this.h = c;
        this.g = !1;
        a = new _.uh();
        b &&
          (b.logo_alignment && _.O(a, 6, un[b.logo_alignment]),
          b.shape && _.O(a, 3, vn[b.shape]),
          b.size && _.O(a, 1, wn[b.size]),
          b.text && _.O(a, 5, xn[b.text]),
          b.theme && _.O(a, 2, yn[b.theme]),
          b.type && _.O(a, 7, zn[b.type]),
          b.width && !isNaN(b.width) && _.O(a, 4, b.width));
    ...
    Km.prototype.toString = function () {
      ...
      this.h && a.push.apply(a, Lm(this.h));
      return a.join('.');
    };
    var Fm = Math.floor(100 * Math.random()),
      Gm = 'https://accounts.google.com/gsi/log',
      Hm,
      Im;
    var Dn = [0, 7200, 86400, 604800, 2419200],
      En = function (a, b, c) {
        this.i = a;
    ...
    */
    ...
    var Nn = { done: !0, value: void 0 },
      On = function (a) {
        if (a.done) throw Ln;
        return a.value;
      };
    Mn.prototype.pa = function () {
      return this;
    };
    var Tn = function (a) {
        if (a instanceof Pn || a instanceof Qn || a instanceof Rn) return a;
    ...
    Yn.prototype.get = function (a) {
      return this.h.get(this.g + a);
    };
    Yn.prototype.mb = function (a) {
      this.h.mb(this.g + a);
    };
    Yn.prototype.pa = function (a) {
      var b = this.h.pa(!0),
        c = this,
        d = new Mn();
      d.next = function () {
        ...
        return { value: a ? f.substr(c.g.length) : c.h.get(f), done: !1 };
      };
      var e = d.next;
      d.ra = function () {
        return On(e.call(d));
    ...
    var Zn = new _.Dk('g_credential_picker'),
      $n = ['bottom_sheet', 'card'],
      ao = ['signin', 'signup', 'use'],
      Z = function (a, b) {
        b = void 0 === b ? 'i_' : b;
        var c = new Xn();
        if (c.g)
        ...
        this.v = d ? new Yn(c, 'g_state_id_') : null;
        this.tc = b;
        ...
        this.A = btoa(String.fromCharCode.apply(String, Lm(b))).replace(
          /=+$/,
          ''
        );
        this.D = {};
    ...
    var bo = function (a, b) {
      ...
      if (c) co(a, c);
        ...
        if ((c = void 0 !== b.log_level))
          (c = b.log_level), (c = void 0 === c || 0 <= (0, _.wa)(rn, c));
        c && co(a, b.log_level);
      }
      ...
      var d = b.client_id,
        e = a.A;
      Gm = c ? c + '/gsi/log' : 'https://accounts.google.com/gsi/log';
      Hm = d;
      Im = e;
      a.callback = b.callback;
      a.ea = 'redirect' === b.ux_mode ? 'redirect' : 'popup';
      c = b.ui_mode;
      (void 0 != c && 0 <= (0, _.wa)($n, c)) ||
        (c = _.Yh() && !_.Zh() ? 'bottom_sheet' : 'card');
      a.uiMode = c;
      a.container =
        (b.prompt_parent_id
      ...
      !c || (null != c && Kn.test(c)) || (c = void 0);
      a.o = new En(c, a.tc, b.state_cookie_name);
      a.va(b);
      c = {};
    ...
    var $m = function (a) {
      a.ia ||
        ...
        (a.I = _.G(document, 'click', function () {
          a.T && fo(a, !1) && (go(a, 'tap_outside'), Om('tapOutside'));
        })));
    };
    Z.prototype.C = function (a, b, c) {
      var d = this;
      fo(this, !0) && (ho(this, 'flow_restarted'), Om('flowRestarted'));
      this.l = a;
      this.fa = c;
      ...
      this.g.client_id
        ? _.J('unsupported_browser')
          ? (Y('One Tap is not supported in this User Agent.'),
            this.j('browser_not_supported'),
            _.yd(this, 'prompt_display_failed', {
              cause: 'Unsupported user agent for one tap.',
            }),
            Nm(a, 'browserNotSupported'))
          : In(this.o)
          ? (Y(
            ...
            Nm(
              a,
              'cooldown',
              (Gn(this.o).prompt_suppress_level || 0).toString()
            ))
          : io(this, function (e) {
              e && _.P(e, 3)
                ? (jo(d), ko(d), lo(d, !0))
                ...
                ? (_.ce(_.H(e, _.Ie, 2)),
                  ...
                  _.yd(d, 'prompt_display_failed', {
                    cause: 'Error while checking for the credential status.',
                  }))
                : e &&
                  !_.P(e, 3) &&
                  (_.ta() || _.Xh() || (_.va() && 0 <= _.Wa(_.Yc(), '14.4'))) &&
                  d.ha
                ? (jo(d), ko(d), lo(d, !0))
                : e && !_.P(e, 3)
    ...
    var cn = function (a, b, c, d) {
        ...
        b.appendChild(h);
        b = _.J('enable_inline_button') ? mo(a, h, c, e) : void 0;
        a.D[e] = {
          iframe_id: e,
          handler: d,
          inline_button: b,
          ...
          d
            ? d.handler
              ...
              : ((b = {}),
                ...
                fo(a, !0) && (ho(a, 'flow_restarted'), Om('buttonFlowStarted')),
                ...
                'redirect' === a.ea
                  ? (a.g.login_uri ||
                      (a.g.login_uri =
                        ...
                        location.pathname),
                    (a.g.g_csrf_token = vm()),
                    (a = _.ak(_.dk(a.wa, a.g))),
                    top.location.replace(_.bk(a)))
                  : ((a.m = _.Nl()),
                    (a.g.channel_id = _.ge(a.m)),
                    (a.g.origin = a.g.origin || location.origin),
                    _.Fk(_.dk(a.wa, a.g), Zn) ||
                      Jm(
                        new Km('button', 'popup', 'clicked', 'popupNotOpened')
                      )))
      ...
      fo = function (a, b) {
        ...
        if (!zm(a.container)) return Y('Failed to remove prompt iframe.'), !1;
        pn(a);
        a.s = !0;
    ...
    var lo = function (a, b, c) {
      ...
      po = function (a, b) {
        a.fa && a.fa.call(a, { type: b, message: void 0 });
      },
      io = function (a, b) {
        ...
        om(c, function (d) {
          d && 'null' !== d
            ...
            : (_.z('Check credential status returns invalid response.'),
              a.j('unknown_reason'),
              _.yd(a, 'network', { cause: 'invalid_response' }));
        });
      },
      jo = function (a) {
        var b = a.g,
        ...
        a.s = !0;
        a.ya(b);
        _.Ek(a, 'prompt_displayed');
      };
    Z.prototype.ya = function (a) {
      Am(this.container, a, 'bottom_sheet' === this.uiMode);
    };
    var ko = function (a) {
        'bottom_sheet' === a.uiMode &&
          window.setTimeout(function () {
            fo(a, !1) && (go(a, 'auto_cancel'), Om('autoCancel'));
          }, a.jc);
      },
      eo = function (a, b) {
      ...
      if (a.data && a.data.type)
        switch (
          ...
          case 'response':
            ...
            b &&
              (d
                ? ho(this, 'credential_returned')
                : (go(this, 'issuing_failed'), Om('issuingFailed')),
              pn(this));
            a.data.announcement && Em(a.data.announcement);
            break;
          case 'activity':
            ...
            if ((b = a.data.command))
              switch (b) {
                case 'close':
                  a.data.suppress &&
                    ...
                    (b.disable_auto_prompt =
                      new Date().getTime() + 1e3 * Dn[b.prompt_suppress_level]),
                    Jm(
                      new Km(
                        'onetap',
                        void 0,
                    ...
                    Hn(a, b));
                  fo(this, !0) &&
                    (go(this, 'user_cancel'), pn(this), Om('userCancel'));
                  break;
                case 'resize':
                  a = a.data.height;
                  if (Cm(a)) {
                ...
                case 'start_auto_select':
                  po(this, 'auto_select_started');
                  break;
                case 'cancel_auto_select':
                  en(this.o), po(this, 'auto_select_canceled');
              }
        }
    };
    Z.prototype.revoke = function (a, b) {
      ...
      d
        ? ((a = { client_id: d, hint: a }),
          this.A && (a.as = this.A),
          pm(this.xc, a, function (e) {
            if (e && 'null' !== e) {
              if (
                ((e = new tn(_.Zc(e))),
                (c.successful = !!_.P(e, 3)),
                Y('Revoke XHR status: ' + c.successful),
                !c.successful)
              )
                if (null != _.F(e, 2)) {
                  e = _.H(e, _.Ie, 2);
    ...
    var Ym = function (a) {
      ...
      if (this.h && this.h)
        if ('string' === typeof this.h) {
          if (!qm(this.h)) throw Error('ra');
        } else if (Array.isArray(this.h))
          for (a = 0; a < this.h.length; a++)
            if ('string' !== typeof this.h[a] || !qm(this.h[a]))
              throw Error('sa');
    };
    _.A(Ym, Z);
      ...
      a.ta ||
        ...
        'credentials' in navigator &&
          navigator.credentials
            .get({ password: !0, ed: 'required' })
            .then(function (b) {
              a.B && a.B(b);
            }));
    };
    Ym.prototype.C = function (a, b, c) {
      var d = this;
      this.F && this.h
        ? (_.w('Verifying parent origin.'),
          _.Wl(this.h, function () {
            _.Ol
              ? _.Pl({ command: 'set_ui_mode', mode: d.uiMode })
              : _.x(
        ...
        switch (a.data.type) {
          ...
          case 'command':
            switch (a.data.command) {
              case 'close':
                this.xa ? _.dm(0) : this.ga ? (_.dm(0), this.ga()) : _.em();
                break;
              case 'resize':
                a = a.data.height;
                'number' === typeof a && !isNaN(a) && 0 < a && _.dm(a);
                break;
              case 'cancel_protect_start':
                _.fm(!1);
                break;
    ...
    Ym.prototype.ya = function (a) {
      Am(this.container, a, 'bottom_sheet' === this.uiMode, this.F);
    };
    Ym.prototype.ua = function (a) {
      if (this.F)
        switch (_.bm) {
    ...
    _.D('google.accounts.id.cancel', function () {
      var a = Zm.__G_ID_CLIENT__;
      a && fo(a, !0) && (ho(a, 'cancel_called'), Om('cancel'));
    });
    _.D('google.accounts.id.disableAutoSelect', fn);
    _.D('google.accounts.id.initialize', an);
    _.D('google.accounts.id.prompt', bn);
    _.D('google.accounts.id.PromptMomentNotification', Cn);
    _.D('google.accounts.id.renderButton', dn);
    _.D('google.accounts.id.revoke', function (a, b) {
      var c = Zm.__G_ID_CLIENT__;
      c ? c.revoke(a, b) : _.z('Attempt to call revoke() before initialize().');
    });
    _.D('google.accounts.id.storeCredential', function (a, b) {
      'credentials' in navigator
        ? navigator.credentials
            .store(a)
            .then(function () {
    ...
    _.D('google.accounts.id.setLogLevel', function (a) {
      var b = Zm.__G_ID_CLIENT__;
      b || (an(), (b = Zm.__G_ID_CLIENT__));
      a = a ? a.toLowerCase() : void 0;
      void 0 === a || 0 <= (0, _.wa)(rn, a)
        ? co(b, a, !0)
        : (_.z(
    ...
    var uo = new _.Dk('g_auth_code_window'),
      vo = function (a) {
        ro.call(this, 'code', a);
    ...
    vo.prototype.requestCode = function () {
      if (_.J('enable_m3') || um(this.g.client_id)) {
        var a = this.g;
        'redirect' === this.o
          ? (Y('Starting redirect flow.', 'CODE_CLIENT'),
            (a = _.ak(ln(this.i, this.j, a))),
            window.location.assign(_.bk(a)))
          : (Y('Starting popup flow.', 'CODE_CLIENT'),
            so(this),
            to(this, a),
            _.Fk(ln(this.i, this.j, a), uo));
      } else
        _.z('Attempted to request code with the experiment off', 'CODE_CLIENT');
    };
    var wo = new _.Dk('g_auth_token_window'),
      xo = window,
      yo = function (a) {
        ro.call(this, 'token', a);
        this.callback = a.callback;
    ...
    yo.prototype.l = function (a) {
      ...
      if (a.access_token)
        if (xo.gapi && xo.gapi.client && xo.gapi.client.setToken)
          try {
            xo.gapi.client.setToken.call(this, a);
          } catch (b) {
        ...
        _.x('Set token failed. No access token in response.', 'TOKEN_CLIENT');
      this.callback && this.callback.call(this, a);
    };
    yo.prototype.requestAccessToken = function (a) {
      if (_.J('enable_m3') || um(this.g.client_id)) {
        var b = this.g;
        a = a || {};
        b = mn(this.i, {
        ...
        so(this);
        to(this, b);
        _.Fk(ln(this.i, this.j, b), wo);
      } else
        _.z(
          'Attempted to request access token with the experiment off',
          'TOKEN_CLIENT'
        );
    };
    _.D('google.accounts.oauth2.initCodeClient', function (a) {
      if (um(a.client_id) || _.J('enable_m3')) return new vo(a);
      _.z(
        'Attempted to initialize Code client with the experiment off.',
        'OAUTH2_API'
      );
    });
    _.D('google.accounts.oauth2.CodeClient', vo);
    _.D('google.accounts.oauth2.initTokenClient', function (a) {
      if (um(a.client_id) || _.J('enable_m3')) return new yo(a);
      _.z(
        'Attempted to initialize Token client with the experiment off.',
        'OAUTH2_API'
      );
    });
    _.D('google.accounts.oauth2.TokenClient', yo);
    _.D('google.accounts.oauth2.hasGrantedAllScopes', function (a) {
      var b = Mm.apply(1, arguments),
        c = on(a);
      return c && c.length
        ? (b = nn.apply(null, Lm(b))) && b.length
          ? (0, _.ab)(b, function (d) {
              return 0 <= (0, _.wa)(c, d);
            })
          : !1
    ...
    _.D('google.accounts.oauth2.hasGrantedAnyScope', function (a) {
      var b = Mm.apply(1, arguments),
        c = on(a);
      return c && c.length
        ? (b = nn.apply(null, Lm(b))) && b.length
    ...
    _.D('google.accounts.oauth2.revoke', function (a, b) {
      pm(
